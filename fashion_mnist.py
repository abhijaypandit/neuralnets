...
if __name__ == "__main__":
    ...
    checkpoint = keras.callbacks.ModelCheckpoint(
        "fashion_mnist_checkpoint.h5", save_best_only=True)

    root_log = os.path.join(os.curdir, "fashion_mnist_log")
    ...
    # Build model
    model = build_model(layers=8, neurons=64, learning_rate=0.03)
    ...
    print("\nSaving model as fashion_mnist.h5")
